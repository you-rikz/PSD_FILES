                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-content">
                                    <div class="sweetalert mt-5">
                                        <button class="btn btn-warning btn sweet-confirm2">Sweet Confirm</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-content">
                                    <div class="sweetalert mt-5">
                                        <button class="btn btn-danger btn expired-auto">Sweet Auto Close</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="template/js/plugins-init/sweetalert.init.js"></script>
<script>
 document.querySelector(".expired-auto").onclick = function() {
    swal({
        title: "TIme's Up!",
        text: "The exam will be submitted in 2 seconds.",
        timer: 2e3,
        showConfirmButton: !1
    })
}
...
document.querySelector(".sweet-confirm2").onclick = function() {
    swal({
